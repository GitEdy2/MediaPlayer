...
const ALL_ADS: Ad[] = [
...

    {
        ...
        body:
        'La ingenierÃ­a de software evoluciona dí­a a dí­a, no te quedes atrás. Ahora que eres un Desarrollador FullStack JavaScript necesitas evolucionar con el software, construye arquitecturas de software modernas.',
...

    {
        ...
        body:
        'React es una de las librerí­as más utilizadas hoy para crear aplicaciones web. Aprende a través de la creación de la interfaz de PlatziVideo todo lo que necesitas para crear increíbles componentes con React.',
